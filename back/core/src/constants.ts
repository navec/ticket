...
/** metadata key of params */
export const BODY_PARAM_METADATA = 'body_param_metadata';
export const PATH_PARAM_METADATA = 'path_param_metadata';
export const QUERY_PARAM_METADATA = 'query_param_metadata';
export const REQ_PARAM_METADATA = 'req_param_metadata';
export const RES_PARAM_METADATA = 'res_param_metadata';
export const SCHEMA_PARAM_METADATA = 'schema_param_metadata';
